...
/**
 * Serviço de dados para gerenciar apresentações
...
export class PresentationService extends BaseCrudService<Presentation> {
  private readonly endpointPath = 'presentations';

  // Override da propriedade endpoint para retornar URL completa
  protected override get endpoint(): string {
    return `${this.envConfig.getApiUrl()}/presentations`;
  }
  ...
  // Adicione métodos específicos de Presentation aqui (se houver)
  // Ex: getPresentationsByVoice(voice: string) { ... }
}
